...
const therapyTypes = [
  {
    ...
    description: "Children ages 1-18 build communication, social, and school-readiness skills through fun and interactive sessions with trained clinicians in an early-childhood environment.",
  ...
  },
  {
    ...
    description: "In-home services bring play-based learning into your home. Children ages 1-18 work 1:1 with a therapist to learn how to apply their lessons to real-life situations.",
  ...
  },
  {
    ...
    description: "Early intensive developmental and behavioral intervention provides ABA therapy for children with autism, ages 1-18, covered by Minnesota Medical Assistance.",
