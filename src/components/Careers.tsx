...
const Careers = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      <main>
        {/* Hero Section */}
        <section className="relative pt-32 pb-20 bg-gradient-to-br from-pacific-cyan/5 via-white to-secondary/5">
            ...
            >
              ...
              <div className="mb-8 flex justify-center">
                <div className="relative w-24 h-24">
                  ...
                  <div className="absolute top-6 left-1/2 -translate-x-1/2 w-16 h-12 bg-pacific-cyan/40 rounded-2xl -rotate-6"></div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-raisin-black mb-6">
                Join the{" "}
                <span className="text-pacific-cyan">Ability Avenues</span> team
              </h1>
          ...
          <div className="container mx-auto px-4">
            <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-6 max-w-7xl mx-auto">
              ...
              >
                ...
                <a
                  href="tel:9529002344"
                  className="text-muted-foreground hover:text-pacific-cyan transition-colors inline-block"
                >
                  (952) 900-2344
                </a>
              </motion.div>
