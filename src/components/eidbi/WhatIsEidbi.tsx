        ...
        <div className="grid lg:grid-cols-[45fr_55fr] gap-12 lg:gap-16 items-center">
          ...
          <div ref={contentRef} className="space-y-6">
            ...
            <div className="inline-block">
              <span className="text-pacific-cyan font-semibold uppercase tracking-wider text-sm">
                Understanding EIDBI
              </span>
            </div>
          ...
          >
            <div className="relative w-full max-w-xl mx-auto">
              ...
              <div className="relative z-10 aspect-square rounded-3xl overflow-hidden bg-gradient-to-br from-cornsilk to-pacific-cyan/10 shadow-lg">
                <Image
                  src="/images/eidbi-understanding-therapy.jpg"
                  alt="Child receiving developmental therapy"
                  fill
