...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex w-full cursor-pointer select-none items-center rounded-sm py-3 pl-8 pr-2 text-sm text-foreground outline-none touch-manipulation active:bg-gray-100 data-[disabled]:pointer-events-none data-[disabled]:opacity-50 focus:bg-gray-100 hover:bg-gray-100",
      className,
    )}
    {...props}
  >
